...
#define FCLK_SLOW() { SD_SPI_HANDLE.Instance->I2SCFGR = 256; }	/* Set SCLK = slow, approx 280 KBits/s*/
#define FCLK_FAST() { SD_SPI_HANDLE.Instance->I2SCFGR = 16; }	/* Set SCLK = fast, approx 4.5 MBits/s */
