...
//void tp_home_page(void){
//	tp_scan(0);
//	if (s_tTouch.chStatus & TP_PRESS_DOWN) {
//		if (s_tTouch.hwXpos < LCD_WIDTH && s_tTouch.hwYpos < LCD_HEIGHT) {
//			if ((s_tTouch.hwYpos > 230 && s_tTouch.hwYpos < 298) && (s_tTouch.hwXpos < 91 && s_tTouch.hwXpos>38)) {
//
//				Storage_OpenReadFile(0, 0, (const char*)"play.BMP");
//				pageNumber=1;
//				PlayWaveFile();
//
//				//flaga na music page
...
//void tp_music_page(void){
//	tp_scan(0);
//	if (s_tTouch.chStatus & TP_PRESS_DOWN) {
//		if (s_tTouch.hwXpos < LCD_WIDTH && s_tTouch.hwYpos < LCD_HEIGHT) {
//			if ((s_tTouch.hwYpos > 32 && s_tTouch.hwYpos < 128) && (s_tTouch.hwXpos < 168 && s_tTouch.hwXpos>72)) {
//				//HAL_I2S_DMAResume(&hi2s2);
//			}
//			else if ((s_tTouch.hwYpos > 192 && s_tTouch.hwYpos < 288) && (s_tTouch.hwXpos < 168 && s_tTouch.hwXpos>72)) {
//				//HAL_I2S_DMAPause(&hi2s2);
//				printf("pizda here2/n/r");
//			}
//		}
//
//	}
